...
//	ImageProcessor GSOproc;
	...
	int miniMapWidth = miniMap_Detector.miniMapWidth; 
	int miniMapHeight = miniMap_Detector.miniMapHeight;
	...
	public crystal_analysis(ImagePlus imgLyso, ImagePlus imgGso){
...
//		GSOproc = GSOimgPlus.getProcessor();
	...
	public ImagePlus getMaxPos(int crystalSel){
		...
		case 0 : 
			...
			IJ.log(String.valueOf(auxStatistics.mean));
			tmpImg = lysoMaxPos;
			break;
		case 1: 
	...
	public ImagePlus[] getMiniMaps(){
		...
		IJ.log(String.valueOf(photoMiniProc.getMaxThreshold()));
