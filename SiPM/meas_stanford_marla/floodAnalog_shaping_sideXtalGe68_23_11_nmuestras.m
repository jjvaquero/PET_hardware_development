...
save('floodAnalog_shaping_sideXtalGe68_2411_resN.mat','valThs','acceptedEvts');
...
save('floodAnalog_shaping_sideXtalGe68_2411_resN.mat','valThs2','floodImg','pAmps','pWidths','-append');
...
save('floodAnalog_shaping_sideXtalGe68_2411_resN.mat','floodImgWidths','-append');

%%
%  Use curve fitting to calculate the new results
%
%do it only fot the 0.45 Vth value
pulseWidths =  squeeze(pWidths(1,:,:));
...
save('floodAnalog_shaping_sideXtalGe68_2411_resN.mat','imgFitted','-append');
...
nData = 3500; %amount of data to save
...
%variables where data will be stored
nData = 3000; %amount of data to save
