...
/**
 *  This function starts the UART3 peripheral
 */
void startCommunicationUART1(){
 ...
 * @return -1 in case of error 0 otherwise
 */
int switchTempComp(unsigned long port, bool status){
