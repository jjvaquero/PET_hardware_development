...
canal1 = zeros(1,2500); histo1 = zeros(1,4096);
canal2 = zeros(1,2500); histo2 = zeros(1,4096);
canal3 = zeros(1,2500); histo3 = zeros(1,4096);
canal4 = zeros(1,2500); histo4 = zeros(1,4096);

for i = 1 : 2500
    if (dataConv(i) ~=0 ) %me aseguro de que no es un valor repetido
        if( dataConv(i) >= 32768) %se trata del cuarto canal
            canal4(ind4) = dataConv(i)-32768;
            ...
            ind4 = ind4+1;
        elseif (dataConv(i) >= 16384)
            canal3(ind3) = dataConv(i)-16384;
            ...
            ind3 = ind3+1;
        elseif (dataConv(i) >= 8192)
            canal2(ind2) = dataConv(i)- 8192;
            ...
            ind2 = ind2+1;
        elseif (dataConv(i) >= 4096)
            canal1(ind1) = dataConv(i)- 4096;
            if( canal1(ind1)> 0 && canal1(ind1) < 4096)
...
save dataconv.mat dataConv data
...
%set(aux,'Parent',handles.axes1);
 ...
 n_events = menor/0.5; %algo mejor seria
