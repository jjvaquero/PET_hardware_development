...
xst -ifn xst.scr
move clk_wiz_v3_6_0_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk_wiz_v3_6_0_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk_wiz_v3_6_0_exdes.ucf clk_wiz_v3_6_0_exdes

echo 'Running map'
map -timing -pr b clk_wiz_v3_6_0_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clk_wiz_v3_6_0_exdes -w routed.ncd routed.vhd
cd ..
