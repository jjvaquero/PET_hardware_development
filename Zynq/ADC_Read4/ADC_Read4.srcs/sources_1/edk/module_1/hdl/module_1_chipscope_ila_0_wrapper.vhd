-------------------------------------------------------------------------------
-- module_1_chipscope_ila_0_wrapper.vhd
-------------------------------------------------------------------------------
library IEEE;
...
entity module_1_chipscope_ila_0_wrapper is
  port (
  ...
  attribute x_core_info of module_1_chipscope_ila_0_wrapper : entity is "chipscope_ila_v1_05_a";

end module_1_chipscope_ila_0_wrapper;

architecture STRUCTURE of module_1_chipscope_ila_0_wrapper is
