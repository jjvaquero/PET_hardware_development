...
fSaveName = 'timing_3x3x3_07_12.mat';
...
while remFiles >0
    ...
    for i = cPos: cPos+toRead-1
        ...
        En1=double(hdf5read(fName,'Waveforms/Channel 1/Channel 1Data'));
        En2=double(hdf5read(fName,'Waveforms/Channel 2/Channel 2Data'));           
...
%  channels
%TODO there is something wrong with this measurement....so...
%lets try to correct it....
valEvents = [];
nEvents = 0;
