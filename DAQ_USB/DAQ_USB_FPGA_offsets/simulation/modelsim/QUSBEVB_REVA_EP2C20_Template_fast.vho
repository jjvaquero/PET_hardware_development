...
SIGNAL \inst6|s~regout\ : std_logic;
...
SIGNAL \inst6|cuenta\ : std_logic_vector(13 DOWNTO 0);
...
-- Equation(s):
-- \inst6|Add0~4_combout\ = (\inst6|cuenta\(2) & (\inst6|Add0~3\ $ (GND))) # (!\inst6|cuenta\(2) & (!\inst6|Add0~3\ & VCC))
-- \inst6|Add0~5\ = CARRY((\inst6|cuenta\(2) & !\inst6|Add0~3\))
...
-- Equation(s):
-- \inst6|Add0~24_combout\ = (\inst6|cuenta\(12) & (\inst6|Add0~23\ $ (GND))) # (!\inst6|cuenta\(12) & (!\inst6|Add0~23\ & VCC))
-- \inst6|Add0~25\ = CARRY((\inst6|cuenta\(12) & !\inst6|Add0~23\))
...
-- Equation(s):
-- \inst6|Add0~26_combout\ = \inst6|Add0~25\ $ (\inst6|cuenta\(13))
...
-- Equation(s):
-- \inst|LessThan0~0_combout\ = (\inst|cuenta_180\(6)) # ((\inst|cuenta_180\(5)) # ((\inst|cuenta_180\(7)) # (\inst|cuenta_180\(4))))
...
-- Equation(s):
-- \inst2|Mux3~2_combout\ = (\inst2|EA\(1)) # (\inst2|Mux3~1_combout\)
...
\inst6|cuenta[3]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ifclk~clkctrl_outclk\,
	datain => \inst6|Add0~6_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst6|cuenta\(3));

-- Location: LCFF_X31_Y21_N7
\inst6|cuenta[2]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ifclk~clkctrl_outclk\,
	datain => \inst6|Add0~4_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst6|cuenta\(2));

-- Location: LCFF_X31_Y21_N15
\inst6|cuenta[6]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ifclk~clkctrl_outclk\,
	datain => \inst6|Add0~12_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst6|cuenta\(6));

-- Location: LCFF_X31_Y21_N17
\inst6|cuenta[7]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ifclk~clkctrl_outclk\,
	datain => \inst6|Add0~14_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst6|cuenta\(7));

-- Location: LCFF_X31_Y21_N25
\inst6|cuenta[11]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ifclk~clkctrl_outclk\,
	datain => \inst6|Add0~22_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst6|cuenta\(11));

-- Location: LCFF_X31_Y21_N29
\inst6|cuenta[13]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ifclk~clkctrl_outclk\,
	datain => \inst6|Add0~26_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst6|cuenta\(13));
...
-- (\inst1|dcfifo_component|auto_generated|rdptr_g\(12) $ (!\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a[12]~2_regout\)))) # (!\inst1|dcfifo_component|auto_generated|rdptr_g\(9) & 
-- (\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a[12]~5_regout\ & (\inst1|dcfifo_component|auto_generated|rdptr_g\(12) $ (!\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a[12]~2_regout\))))
...
-- Equation(s):
-- \inst2|Mux18~1_combout\ = (\inst2|EA\(1) & !\inst2|EA\(0))
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|wrptr_gp|_~10_combout\ = \inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a\(7) $ (\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a\(4) $ 
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|wrptr_g1p|_~12_combout\ = \inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a1~regout\ $ (\inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a3~regout\ $ 
-- (\inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a2~regout\ $ (!\inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a0~regout\)))
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|wrptr_g1p|_~10_combout\ = \inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a8~1_combout\ $ (\inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a11~0_combout\ $ 
-- (\inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a9~0_combout\ $ (!\inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a10~0_combout\)))
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|wrptr_g1p|_~11_combout\ = \inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a7~regout\ $ (\inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a4~regout\ $ 
-- (\inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a6~regout\ $ (\inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a5~regout\)))
...
PORT MAP (
	...
	datab => \inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a4~regout\,
	datac => \inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a6~regout\,
	datad => \inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a5~regout\,
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|wrptr_g1p|_~8_combout\ = \inst1|dcfifo_component|auto_generated|wrptr_g1p|sub_parity10a\(0) $ (\inst1|dcfifo_component|auto_generated|wrptr_g1p|sub_parity10a\(2) $ 
...
PORT MAP (
	...
	datab => \inst1|dcfifo_component|auto_generated|wrptr_g1p|sub_parity10a\(2),
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|rdptr_g1p|_~0_combout\ = (\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a[12]~15_regout\ & (!\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a[12]~12_regout\ & 
-- (\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a[12]~14_regout\ & \inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a[12]~13_regout\)))
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a[2]~18_combout\ = \inst1|dcfifo_component|auto_generated|wrptr_gp|_~4_combout\ $ (\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a\(2))
...
-- pragma translate_on
PORT MAP (
	datab => \inst1|dcfifo_component|auto_generated|wrptr_gp|_~4_combout\,
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|wrptr_gp|_~1_combout\ = (!\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a\(0) & (!\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a\(1) & 
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|wrptr_gp|_~6_combout\ = (!\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a\(7) & (!\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a\(6) & 
-- (!\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a\(5) & \inst1|dcfifo_component|auto_generated|wrptr_gp|_~3_combout\)))
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|wrptr_gp|_~11_combout\ = \inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a[8]~13_combout\ $ (\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a[9]~10_combout\ $ 
-- (\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a[10]~12_combout\ $ (\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a[11]~11_combout\)))
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|wrptr_gp|_~0_combout\ = (\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a[12]~6_regout\ & (\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a[12]~5_regout\ & 
-- \inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a[12]~7_regout\))
...
-- (!\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a[12]~3_regout\ & \inst1|dcfifo_component|auto_generated|wrptr_gp|_~0_combout\))))
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|wrptr_gp|_~9_combout\ = \inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a\(0) $ (\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a\(2) $ 
-- (\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a\(3) $ (!\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a\(1))))
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|wrptr_gp|_~8_combout\ = \inst1|dcfifo_component|auto_generated|wrptr_gp|sub_parity12a1~regout\ $ (\inst1|dcfifo_component|auto_generated|wrptr_gp|sub_parity12a2~regout\ $ 
...
-- (\inst1|dcfifo_component|auto_generated|rdcnt_addr_ena~combout\ & \inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(1))))
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a[3]~26_combout\ = \inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(3) $ (((\inst1|dcfifo_component|auto_generated|rdptr_g1p|_~5_combout\ & 
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|rdemp_eq_comp_lsb_mux|result_node[0]~8_combout\ = (!\inst1|dcfifo_component|auto_generated|valid_rdreq~0_combout\ & (\inst1|dcfifo_component|auto_generated|rdemp_eq_comp_lsb_mux|result_node[0]~6_combout\ & 
-- (\inst1|dcfifo_component|auto_generated|rdemp_eq_comp_lsb_mux|result_node[0]~7_combout\ & \inst1|dcfifo_component|auto_generated|rdemp_eq_comp_lsb_mux|result_node[0]~5_combout\)))
...
PORT MAP (
	dataa => \inst1|dcfifo_component|auto_generated|valid_rdreq~0_combout\,
	datab => \inst1|dcfifo_component|auto_generated|rdemp_eq_comp_lsb_mux|result_node[0]~6_combout\,
	datac => \inst1|dcfifo_component|auto_generated|rdemp_eq_comp_lsb_mux|result_node[0]~7_combout\,
	datad => \inst1|dcfifo_component|auto_generated|rdemp_eq_comp_lsb_mux|result_node[0]~5_combout\,
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a[4]~27_combout\ = \inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(4) $ (((\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(3) & 
-- (\inst1|dcfifo_component|auto_generated|rdptr_g1p|_~5_combout\ & !\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(2)))))
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|rdemp_eq_comp_lsb_mux|result_node[0]~2_combout\ = (\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(0) & (\inst1|dcfifo_component|auto_generated|delayed_wrptr_g\(0) & 
-- (\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(3) $ (!\inst1|dcfifo_component|auto_generated|delayed_wrptr_g\(3))))) # (!\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(0) & 
-- (!\inst1|dcfifo_component|auto_generated|delayed_wrptr_g\(0) & (\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(3) $ (!\inst1|dcfifo_component|auto_generated|delayed_wrptr_g\(3)))))
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|rdemp_eq_comp_msb_mux|result_node[0]~1_combout\ = (\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a[9]~19_combout\ & (!\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a[12]~5_regout\ & 
-- (\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a[7]~16_combout\ $ (!\inst1|dcfifo_component|auto_generated|delayed_wrptr_g\(7))))) # (!\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a[9]~19_combout\ & 
-- (\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a[12]~5_regout\ & (\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a[7]~16_combout\ $ (!\inst1|dcfifo_component|auto_generated|delayed_wrptr_g\(7)))))
...
-- (\inst1|dcfifo_component|auto_generated|rdempty_eq_comp_msb|data_wire[0]~0_combout\ & ((!\inst1|dcfifo_component|auto_generated|rdemp_eq_comp_msb_mux|result_node[0]~0_combout\) # 
-- (!\inst1|dcfifo_component|auto_generated|rdemp_eq_comp_msb_mux|result_node[0]~4_combout\)))) # (!\inst1|dcfifo_component|auto_generated|rdemp_eq_comp_msb_mux|result_node[0]~8_combout\ & 
...
PORT MAP (
	...
	datac => \inst1|dcfifo_component|auto_generated|rdempty_eq_comp_msb|data_wire[0]~0_combout\,
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|rdptr_g1p|_~11_combout\ = \inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(1) $ (\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(3) $ 
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|rdptr_g1p|_~12_combout\ = \inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(4) $ (\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(6) $ 
-- (\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(5) $ (\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a[7]~16_combout\)))
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|rdptr_g1p|_~6_combout\ = (\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(4) & (\inst1|dcfifo_component|auto_generated|rdptr_g1p|_~5_combout\ & 
-- (!\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(2) & !\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(3))))
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|rdptr_g1p|_~7_combout\ = (!\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(4) & (\inst1|dcfifo_component|auto_generated|rdptr_g1p|_~5_combout\ & 
-- (!\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(2) & !\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a\(3))))
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|rdptr_g1p|_~1_combout\ = (\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a[12]~15_regout\ & (\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a[12]~12_regout\ & 
-- (\inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a[12]~14_regout\ & \inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a[12]~13_regout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst1|dcfifo_component|auto_generated|rdptr_g1p|counter7a[13]~6_regout\,
...
-- (\inst1|dcfifo_component|auto_generated|rdptr_g\(13) $ (\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a[13]~8_combout\)))) # (!\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a[12]~9_combout\ & 
-- (\inst1|dcfifo_component|auto_generated|rdptr_g\(12) & (\inst1|dcfifo_component|auto_generated|rdptr_g\(13) $ (\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a[13]~8_combout\))))
...
-- (\inst1|dcfifo_component|auto_generated|rdptr_g\(10) $ (!\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a[10]~12_combout\)))) # (!\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a\(7) & 
-- (!\inst1|dcfifo_component|auto_generated|rdptr_g\(7) & (\inst1|dcfifo_component|auto_generated|rdptr_g\(10) $ (!\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a[10]~12_combout\))))
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|wrfull_eq_comp_msb_mux|result_node[0]~4_RESYN30_BDD31\ = (\inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a10~0_combout\ & (!\inst1|dcfifo_component|auto_generated|rdptr_g\(10) & 
-- (\inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a7~regout\ $ (!\inst1|dcfifo_component|auto_generated|rdptr_g\(7))))) # (!\inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a10~0_combout\ & 
-- (\inst1|dcfifo_component|auto_generated|rdptr_g\(10) & (\inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a7~regout\ $ (!\inst1|dcfifo_component|auto_generated|rdptr_g\(7)))))
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|wrfull_eq_comp_msb_mux|result_node[0]~4_RESYN28_BDD29\ = \inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a12~4_regout\ $ (\inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a8~0_regout\ $ 
-- (\inst1|dcfifo_component|auto_generated|rdptr_g\(8)))
...
PORT MAP (
	...
	datac => \inst1|dcfifo_component|auto_generated|wrfull_eq_comp_msb_mux|result_node[0]~7_combout\,
...
-- (!\inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a1~regout\ & \inst1|dcfifo_component|auto_generated|wrptr_g1p|_~4_combout\))))
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|wrfull_eq_comp_lsb_mux|result_node[0]~5_combout\ = (\inst1|dcfifo_component|auto_generated|rdptr_g\(4) & (\inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a4~regout\ & 
-- (\inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a5~regout\ $ (!\inst1|dcfifo_component|auto_generated|rdptr_g\(5))))) # (!\inst1|dcfifo_component|auto_generated|rdptr_g\(4) & (!\inst1|dcfifo_component|auto_generated|wrptr_g1p|counter8a4~regout\ 
...
-- Equation(s):
-- \inst1|dcfifo_component|auto_generated|wrfull_eq_comp_lsb_mux|result_node[0]~4_RESYN24_BDD25\ = (\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a\(6) & (\inst1|dcfifo_component|auto_generated|rdptr_g\(6) & 
-- (\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a\(5) $ (!\inst1|dcfifo_component|auto_generated|rdptr_g\(5))))) # (!\inst1|dcfifo_component|auto_generated|wrptr_gp|counter13a\(6) & (!\inst1|dcfifo_component|auto_generated|rdptr_g\(6) & 
...
-- Equation(s):
-- \inst5~0_combout\ = (\NBusy2~combout\ & (\NBusy3~combout\ & (\NBusy4~combout\ & \NBusy1~combout\)))
...
\inst6|cuenta[12]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ifclk~clkctrl_outclk\,
	datain => \inst6|Add0~24_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst6|cuenta\(12));

-- Location: LCCOMB_X31_Y21_N2
\inst6|Add0~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst6|Add0~0_combout\ = \inst6|cuenta\(0) $ (VCC)
-- \inst6|Add0~1\ = CARRY(\inst6|cuenta\(0))
...
-- pragma translate_on
PORT MAP (
	datab => \inst6|cuenta\(0),
	datad => VCC,
	combout => \inst6|Add0~0_combout\,
	cout => \inst6|Add0~1\);

-- Location: LCFF_X31_Y21_N3
\inst6|cuenta[0]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ifclk~clkctrl_outclk\,
	datain => \inst6|Add0~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst6|cuenta\(0));

-- Location: LCCOMB_X31_Y21_N4
\inst6|Add0~2\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst6|Add0~2_combout\ = (\inst6|cuenta\(1) & (!\inst6|Add0~1\)) # (!\inst6|cuenta\(1) & ((\inst6|Add0~1\) # (GND)))
-- \inst6|Add0~3\ = CARRY((!\inst6|Add0~1\) # (!\inst6|cuenta\(1)))
...
\inst6|cuenta[1]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ifclk~clkctrl_outclk\,
	datain => \inst6|Add0~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst6|cuenta\(1));

-- Location: LCCOMB_X31_Y21_N8
\inst6|Add0~6\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst6|Add0~6_combout\ = (\inst6|cuenta\(3) & (!\inst6|Add0~5\)) # (!\inst6|cuenta\(3) & ((\inst6|Add0~5\) # (GND)))
-- \inst6|Add0~7\ = CARRY((!\inst6|Add0~5\) # (!\inst6|cuenta\(3)))
...
-- Equation(s):
-- \inst6|Add0~8_combout\ = (\inst6|cuenta\(4) & (\inst6|Add0~7\ $ (GND))) # (!\inst6|cuenta\(4) & (!\inst6|Add0~7\ & VCC))
-- \inst6|Add0~9\ = CARRY((\inst6|cuenta\(4) & !\inst6|Add0~7\))
...
\inst6|cuenta[4]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ifclk~clkctrl_outclk\,
	datain => \inst6|Add0~8_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst6|cuenta\(4));

-- Location: LCCOMB_X31_Y21_N12
\inst6|Add0~10\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst6|Add0~10_combout\ = (\inst6|cuenta\(5) & (!\inst6|Add0~9\)) # (!\inst6|cuenta\(5) & ((\inst6|Add0~9\) # (GND)))
-- \inst6|Add0~11\ = CARRY((!\inst6|Add0~9\) # (!\inst6|cuenta\(5)))
...
\inst6|cuenta[5]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ifclk~clkctrl_outclk\,
	datain => \inst6|Add0~10_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst6|cuenta\(5));

-- Location: LCCOMB_X31_Y21_N14
\inst6|Add0~12\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst6|Add0~12_combout\ = (\inst6|cuenta\(6) & (\inst6|Add0~11\ $ (GND))) # (!\inst6|cuenta\(6) & (!\inst6|Add0~11\ & VCC))
-- \inst6|Add0~13\ = CARRY((\inst6|cuenta\(6) & !\inst6|Add0~11\))
...
-- Equation(s):
-- \inst6|Add0~14_combout\ = (\inst6|cuenta\(7) & (!\inst6|Add0~13\)) # (!\inst6|cuenta\(7) & ((\inst6|Add0~13\) # (GND)))
-- \inst6|Add0~15\ = CARRY((!\inst6|Add0~13\) # (!\inst6|cuenta\(7)))
...
-- Equation(s):
-- \inst6|Add0~16_combout\ = (\inst6|cuenta\(8) & (\inst6|Add0~15\ $ (GND))) # (!\inst6|cuenta\(8) & (!\inst6|Add0~15\ & VCC))
-- \inst6|Add0~17\ = CARRY((\inst6|cuenta\(8) & !\inst6|Add0~15\))
...
\inst6|cuenta[8]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ifclk~clkctrl_outclk\,
	datain => \inst6|Add0~16_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst6|cuenta\(8));

-- Location: LCCOMB_X31_Y21_N20
\inst6|Add0~18\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst6|Add0~18_combout\ = (\inst6|cuenta\(9) & (!\inst6|Add0~17\)) # (!\inst6|cuenta\(9) & ((\inst6|Add0~17\) # (GND)))
-- \inst6|Add0~19\ = CARRY((!\inst6|Add0~17\) # (!\inst6|cuenta\(9)))
...
\inst6|cuenta[9]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ifclk~clkctrl_outclk\,
	datain => \inst6|Add0~18_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst6|cuenta\(9));

-- Location: LCCOMB_X31_Y21_N22
\inst6|Add0~20\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst6|Add0~20_combout\ = (\inst6|cuenta\(10) & (\inst6|Add0~19\ $ (GND))) # (!\inst6|cuenta\(10) & (!\inst6|Add0~19\ & VCC))
-- \inst6|Add0~21\ = CARRY((\inst6|cuenta\(10) & !\inst6|Add0~19\))
...
\inst6|cuenta[10]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ifclk~clkctrl_outclk\,
	datain => \inst6|Add0~20_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst6|cuenta\(10));

-- Location: LCCOMB_X31_Y21_N24
\inst6|Add0~22\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst6|Add0~22_combout\ = (\inst6|cuenta\(11) & (!\inst6|Add0~21\)) # (!\inst6|cuenta\(11) & ((\inst6|Add0~21\) # (GND)))
-- \inst6|Add0~23\ = CARRY((!\inst6|Add0~21\) # (!\inst6|cuenta\(11)))
...
-- Equation(s):
-- \inst6|LessThan0~0_combout\ = (!\inst6|Add0~10_combout\ & (!\inst6|Add0~12_combout\ & (!\inst6|Add0~6_combout\ & !\inst6|Add0~8_combout\)))
...
-- Equation(s):
-- \inst6|LessThan0~1_combout\ = (((\inst6|LessThan0~0_combout\) # (!\inst6|Add0~14_combout\)) # (!\inst6|Add0~16_combout\)) # (!\inst6|Add0~18_combout\)
...
\inst6|LessThan0~2\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst6|LessThan0~2_combout\ = (!\inst6|Add0~22_combout\ & !\inst6|Add0~20_combout\)
...
-- Equation(s):
-- \inst6|LessThan0~3_combout\ = (\inst6|Add0~26_combout\) # ((\inst6|Add0~24_combout\ & ((!\inst6|LessThan0~2_combout\) # (!\inst6|LessThan0~1_combout\))))
...
PORT MAP (
	...
	datac => \inst6|LessThan0~1_combout\,
	datad => \inst6|LessThan0~2_combout\,
	combout => \inst6|LessThan0~3_combout\);

-- Location: LCFF_X32_Y21_N25
\inst6|s\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ifclk~clkctrl_outclk\,
	datain => \inst6|LessThan0~3_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst6|s~regout\);
...
-- Equation(s):
-- \inst|Mux3~0_combout\ = (\inst|EA\(0) & (!\inst|LessThan0~0_combout\ & ((!\inst|cuenta_180\(8))))) # (!\inst|EA\(0) & (((\inst6|s~regout\))))
...
-- Equation(s):
-- \inst2|Mux24~1_combout\ = (\inst2|EA\(1)) # ((\inst2|EA\(0)) # ((\inst2|EA\(2)) # (!\inst|EA\(1))))
...
-- Equation(s):
-- \inst2|Mux18~0_combout\ = (\inst2|EA\(1) & \inst2|EA\(0))
...
-- Equation(s):
-- \inst2|Mux18~2_combout\ = (!\inst2|EA\(1) & \inst2|EA\(0))
...
PORT MAP (
	dataa => \inst1|dcfifo_component|auto_generated|fifo_ram|altsyncram14|out_address_reg_a\(0),
	datab => \inst1|dcfifo_component|auto_generated|fifo_ram|altsyncram14|ram_block15a26~portadataout\,
