...
SIGNAL \inst|EA[0]~0_regout\ : std_logic;
...
SIGNAL \inst|EA[0]~1_regout\ : std_logic;
...
-- Equation(s):
-- \inst|Mux1~1_combout\ = (\inst|cuenta_180\(4) & (\inst|cuenta_180\(2) & ((\inst|cuenta_180\(1)) # (\inst|cuenta_180\(0)))))
...
-- Equation(s):
-- \inst|Mux1~2_combout\ = ((\inst|Mux1~1_combout\) # ((\inst|cuenta_180\(3) & \inst|cuenta_180\(4)))) # (!\inst|LessThan1~0_combout\)
...
-- Equation(s):
-- \inst|Mux7~2_combout\ = (\inst|Mux7~1_combout\ & (((!\inst|Mux7~0_combout\ & \inst|Mux1~2_combout\)) # (!\IO_E3~combout\)))
...
\inst|EA[0]~0\ : cycloneii_lcell_ff
PORT MAP (
	clk => \inst1|altpll_component|_clk1~clkctrl_outclk\,
	datain => \inst|Mux7~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst|EA[0]~0_regout\);

-- Location: LCCOMB_X2_Y20_N28
\inst|Mux2~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst|Mux2~1_combout\ = (\inst|EA\(1) & ((\IO_E3~combout\) # ((!\inst|EA[0]~0_regout\ & !\inst|EA[0]~1_regout\)))) # (!\inst|EA\(1) & (((\inst|EA[0]~0_regout\) # (\inst|EA[0]~1_regout\))))
...
PORT MAP (
	dataa => \inst|EA\(1),
	datab => \IO_E3~combout\,
	datac => \inst|EA[0]~0_regout\,
	datad => \inst|EA[0]~1_regout\,
...
-- Equation(s):
-- \inst|LessThan1~1_combout\ = (\inst|cuenta_180\(4)) # ((\inst|cuenta_180\(3)) # ((\inst|cuenta_180\(2) & \inst|cuenta_180\(1))))
...
-- Equation(s):
-- \inst|Mux2~0_combout\ = (\inst|EA\(2) & (\inst|LessThan1~0_combout\ & (!\inst|Mux7~0_combout\ & !\inst|LessThan1~1_combout\)))
...
-- Equation(s):
-- \inst|Mux6~0_combout\ = (\inst|EA\(1) & (\IO_E3~combout\ & ((\inst|EA[0]~1_regout\) # (\inst|EA[0]~0_regout\)))) # (!\inst|EA\(1) & (((\inst|EA[0]~1_regout\) # (\inst|EA[0]~0_regout\))))
...
PORT MAP (
	dataa => \inst|EA\(1),
	datab => \IO_E3~combout\,
	datac => \inst|EA[0]~1_regout\,
	datad => \inst|EA[0]~0_regout\,
	combout => \inst|Mux6~0_combout\);

-- Location: LCCOMB_X1_Y20_N10
\inst|Mux6~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst|Mux6~1_combout\ = (\inst|EA\(1) & (((!\inst|Mux6~0_combout\)))) # (!\inst|EA\(1) & (\inst|Mux6~0_combout\ & ((\inst|LessThan1~1_combout\) # (!\inst|LessThan1~0_combout\))))
...
-- Equation(s):
-- \inst|Mux7~1_combout\ = (!\inst|EA\(2) & \inst|EA\(1))
...
-- Equation(s):
-- \inst|Mux0~0_combout\ = (\inst|Mux2~0_combout\) # ((\IO_E3~combout\ & (\inst|Mux7~1_combout\ & \inst|Mux7~0_combout\)))
...
-- Equation(s):
-- \inst|Mux2~2_combout\ = (\inst|EA\(1) & (((\inst|EA\(2))) # (!\inst|Mux2~1_combout\))) # (!\inst|EA\(1) & (!\inst|Mux2~0_combout\ & ((\inst|EA\(2)) # (!\inst|Mux2~1_combout\))))
...
-- Equation(s):
-- \inst|Mux7~3_combout\ = (\inst|Mux7~0_combout\ & (\inst|LessThan1~0_combout\ & (!\inst|LessThan1~1_combout\))) # (!\inst|Mux7~0_combout\ & (((\IO_E1~combout\))))
...
-- Equation(s):
-- \inst|Mux7~4_combout\ = (!\inst|EA\(1) & (\inst|Mux7~3_combout\ & !\inst|EA\(2)))
...
\inst|EA[0]~1\ : cycloneii_lcell_ff
PORT MAP (
	clk => \inst1|altpll_component|_clk1~clkctrl_outclk\,
	datain => \inst|Mux7~4_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \inst|EA[0]~1_regout\);

-- Location: LCCOMB_X2_Y20_N24
\inst|Mux7~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst|Mux7~0_combout\ = (\inst|EA[0]~1_regout\) # (\inst|EA[0]~0_regout\)
...
-- Equation(s):
-- \inst|Mux1~0_combout\ = (!\inst|EA\(1) & (((\inst|LessThan1~0_combout\ & !\inst|LessThan1~1_combout\)) # (!\inst|Mux7~0_combout\)))
...
-- Equation(s):
-- \inst|Mux3~0_combout\ = (\inst|EA\(1) & ((GLOBAL(\inst1|altpll_component|_clk1~clkctrl_outclk\)) # ((\inst|EA[0]~1_regout\) # (\inst|EA[0]~0_regout\)))) # (!\inst|EA\(1) & (((!\inst|EA[0]~1_regout\ & !\inst|EA[0]~0_regout\))))
...
PORT MAP (
	dataa => \inst|EA\(1),
	datab => \inst1|altpll_component|_clk1~clkctrl_outclk\,
	datac => \inst|EA[0]~1_regout\,
	datad => \inst|EA[0]~0_regout\,
...
-- Equation(s):
-- \inst|Mux4~0_combout\ = (\inst|EA[0]~1_regout\) # ((\inst|EA\(2)) # (\inst|EA[0]~0_regout\))
