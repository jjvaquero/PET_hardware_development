...
SIGNAL \inst|Mux7~0_Duplicate_4\ : std_logic;
...
SIGNAL \inst|PA_0~combout\ : std_logic;
...
-- Equation(s):
-- \inst|LessThan0~1_combout\ = (\inst|cuenta_180\(5)) # ((\inst|cuenta_180\(6)) # ((\inst|cuenta_180\(7)) # (\inst|cuenta_180\(4))))
...
-- Equation(s):
-- \inst|Mux1~0_combout\ = (\inst|EA\(2) & ((\inst|EA\(0)))) # (!\inst|EA\(2) & ((!\inst|EA\(0)) # (!\inst|EA\(1))))
...
-- Equation(s):
-- \inst|Mux1~1_combout\ = (\inst|Mux1~0_combout\) # ((\inst|EA\(2) & ((\inst|LessThan0~2_combout\))) # (!\inst|EA\(2) & (!\inst|Mux6~0_combout\)))
...
-- Equation(s):
-- \inst|EA[2]~0_combout\ = !\inst|Mux1~1_combout\
...
\inst|Mux7~0_Duplicate\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst|Mux7~0_Duplicate_4\ = (\IO_E3~combout\ & ((!\inst|EA\(0)) # (!\inst2|q5_Entrada~regout\)))
...
PORT MAP (
	...
	datac => \IO_E3~combout\,
	datad => \inst|EA\(0),
	combout => \inst|Mux7~0_Duplicate_4\);

-- Location: LCCOMB_X47_Y18_N4
\inst|Mux7~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst|Mux7~1_combout\ = (\inst|EA\(0) & (!\inst|LessThan0~2_combout\)) # (!\inst|EA\(0) & ((\inst2|q5_Entrada~regout\)))
...
-- Equation(s):
-- \inst|Mux7~2_combout\ = (!\inst|EA\(2) & ((\inst|EA\(1) & (!\inst|Mux7~0_Duplicate_4\)) # (!\inst|EA\(1) & ((\inst|Mux7~1_combout\)))))
...
-- Equation(s):
-- \inst|Mux3~1_combout\ = (!\inst|EA\(0) & \inst|EA\(2))
...
-- Equation(s):
-- \inst|Mux3~0_combout\ = (!\inst|EA\(2) & ((\inst|EA\(1) & ((\inst|Mux7~0_Duplicate_4\))) # (!\inst|EA\(1) & (\inst|EA\(0)))))
...
PORT MAP (
	...
	datab => \inst|EA\(2),
	datac => \inst|EA\(0),
	datad => \inst|Mux7~0_Duplicate_4\,
	combout => \inst|Mux3~0_combout\);

-- Location: LCCOMB_X46_Y18_N30
\inst|Mux3~2\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst|Mux3~2_combout\ = (!\inst|Mux3~0_combout\ & ((\inst|EA\(1)) # ((\inst|LessThan0~2_combout\) # (!\inst|Mux3~1_combout\))))
...
-- Equation(s):
-- \inst|LessThan0~0_combout\ = (\inst|cuenta_180\(3) & ((\inst|cuenta_180\(2)) # ((\inst|cuenta_180\(1) & \inst|cuenta_180\(0)))))
...
-- Equation(s):
-- \inst|LessThan0~2_combout\ = (\inst|LessThan0~1_combout\) # ((\inst|cuenta_180\(8)) # (\inst|LessThan0~0_combout\))
...
-- Equation(s):
-- \inst|Mux6~0_combout\ = (\IO_E3~combout\ & !\inst2|q5_Entrada~regout\)
...
-- Equation(s):
-- \inst|Mux6~1_combout\ = (\inst|EA\(0) & ((\inst|EA\(1) & ((!\inst|Mux6~0_combout\))) # (!\inst|EA\(1) & (\inst|LessThan0~2_combout\)))) # (!\inst|EA\(0) & (((\inst|EA\(1)))))
...
-- Equation(s):
-- \inst|Mux2~0_combout\ = (!\inst|EA\(1) & ((!\inst|EA\(0)) # (!\inst|LessThan0~2_combout\)))
...
-- Equation(s):
-- \inst|Mux4~0_combout\ = (\inst|EA\(1)) # ((\inst|EA\(2) & GLOBAL(\inst1|altpll_component|_clk0~clkctrl_outclk\)))
...
\inst|PA_0\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst|PA_0~combout\ = (\inst|Mux3~1_combout\ & (\inst|PA_0~combout\)) # (!\inst|Mux3~1_combout\ & ((\inst|EA\(0))))
...
-- pragma translate_on
PORT MAP (
	datab => \inst|PA_0~combout\,
	datac => \inst|Mux3~1_combout\,
	datad => \inst|EA\(0),
	combout => \inst|PA_0~combout\);
...
-- pragma translate_on
PORT MAP (
	datain => \inst|ALT_INV_Mux1~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	devoe => ww_devoe,
	oe => VCC,
